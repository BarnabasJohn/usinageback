...
class Client(AbstractUser):
    ...
    profile_pic = CloudinaryField('image', folder='client-images', blank=True, null=True)
    username = None
...
class Request2(models.Model):
    ...
    image1 = CloudinaryField('image', folder='request-images', blank=True, null=True)
    image2 = CloudinaryField('image', folder='request-images', blank=True, null=True)
    image3 = CloudinaryField('image', folder='request-images', blank=True, null=True)
    image4 = CloudinaryField('image', folder='request-images', blank=True, null=True)
    image5 = CloudinaryField('image', folder='request-images', blank=True, null=True)
    #file1 = models.FileField(upload_to='client-documents/', blank=True, null=True)
    #file1 = models.URLField(max_length=500, blank=True, null=True)
    file1 = CloudinaryField('file', folder='client-documents', blank=True, null=True)
    file2 = CloudinaryField('file', folder='client-documents', blank=True, null=True)
    file3 = CloudinaryField('file', folder='client-documents', blank=True, null=True)
    material = models.CharField(max_length=200)
    offer_type = models.CharField(choices=OFFER_TYPE_CHOICES, max_length=20, default='Classic')
    description = models.CharField(max_length=2000, null=False, blank=False)
    urgent = models.BooleanField(default=False)
