...
class RequestSerializerPolite(serializers.ModelSerializer):
    class Meta:
        model = Request2
        fields = ['accepted_manufacturer_id',
                    'title', 'material', 'offer_type',
                    'description', 'urgent', 'quantity',
                    'mailbox_send', 'relaypoint_send',
                    'deadline', 'completed_status',
                    'completed_date']
