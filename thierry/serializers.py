...
from .models import News, ClientFAQ, ManFAQ, Contact, Admin, ClientPayment, ManufacturerWithdrawal
...
class ManWithdrawSerializer(serializers.ModelSerializer):
    class Meta:
        model = ManufacturerWithdrawal
        fields = '__all__'